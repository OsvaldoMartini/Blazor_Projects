...
namespace BlazorChessComponent.Engine
{
    public class ChessEngine
    {
        ...
        {
            JsInterop.GetElementBoundingClientRect(RectID, new DotNetObjectRef(this));
        }
        ...
        bool figuris_gadaadgilebit_ixsneba_shaxi()
        {
            ...
            if (Curr_Figure.kodi.ToLower() != "a")
            {
                ...
                {
                    JsInterop.alert("არალოგიკური შეცდომა, მეფე ვერ მოიძებნა დაფაზე! (function figuris_gadaadgilebit_ixsneba_shaxi)");
                }
        ...
        [JSInvokable]
        public void invokeFromjs(string id, double x, double y)
        {
            compSettings.BoardPositionX = x;
            compSettings.BoardPositionY = y;
        }
